...
test_that("values", {
  ex8_detailOut <- ex8_prevsims <- NULL
  ...
  expect_equal(ex8$detailOut$Exp.Sn,
               ...
               tolerance = 0.000001)
  expect_equal(ex8$detailOut$Exp.Sp,
               ex8_detailOut$Exp.Sp,
               tolerance = 0.000001)
  expect_equal(ex8$detailOut$Converge,
               ex8_detailOut$Converge,
               tolerance = 0)
  ...
  dimnames(ex8$input$prev.sims) <- NULL
  dimnames(ex8_prevsims) <- NULL
