...
test_that("initial values", {
  ...
  expect_equal(ex1$detailOut$Exp.Sp, ex1_detailOut$Exp.Sp, tolerance = 0.000001)
  expect_equal(ex1$detailOut$Converge, ex1_detailOut$Converge, tolerance = 0)
  expect_equal(ex1$detailOut$Message, ex1_detailOut$Message)
